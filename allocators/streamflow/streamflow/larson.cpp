...
extern "C" {
#endif
extern void * hoardmalloc(size_t) __THROW __attribute_malloc__;
extern void hoardfree (void*) __THROW;
extern void * hoardcalloc(size_t, size_t) __THROW __attribute_malloc__;
extern void * hoardrealloc(void *,size_t) __THROW __attribute_malloc__;
#if defined(__cplusplus)
}
#endif
...
void runthreads(long sleep_cnt, int min_threads, int max_threads, int chperthread, int num_rounds)
{
  ...
  for(num_threads=min_threads; num_threads <= max_threads; num_threads++ )
	...
	rate_1 = rate_n ;
      ...
      printf ("%8.0f operations per second, %2d threads.\n", sum_allocs / duration, sum_threads);
