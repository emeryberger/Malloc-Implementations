...
/*
  ...
  set to zero.
*/
void* dlcalloc(size_t, size_t) throw();
...
void* dlrealloc(void*, size_t) throw();
...
*/
void* dlmemalign(size_t, size_t) throw();
...
static int win32munmap(void* ptr, size_t size) {
  ...
  char* cptr = static_cast<char *>(ptr); // EDB
  while (size) {
...
void* dlmemalign(size_t alignment, size_t bytes) throw() {
