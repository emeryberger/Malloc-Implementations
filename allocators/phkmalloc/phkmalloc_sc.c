...
malloc_make_chunks(int chunksize)	/* <eric> the input is now the chunk size */
{
    ...
    /* <eric> l += sizeof bp->bits[0] *
	   (((malloc_pagesize >> bits)+MALLOC_BITS-1) / MALLOC_BITS); */
    l += sizeof bp->bits[0] *
		(((malloc_pagesize / chunksize)+MALLOC_BITS-1) / MALLOC_BITS);	/* <eric> */
...
malloc_bytes(size_t size)
{
    ...
    *lp ^= u;
    ...
    /* <eric> k <<= bp->shift; */
	k *= bp->size;		/* <eric> chunks are no longer powers of two */
...
irealloc(void *ptr, size_t size)
{
	...
	/* <eric> i = ((u_long)ptr & malloc_pagemask) >> (*mp)->shift; */
	i = ((u_long)ptr & malloc_pagemask) / (*mp)->size;	/* <eric> */
